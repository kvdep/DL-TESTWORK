...
filename = f'CATS-R2+F_2A_5.3-{time.localtime()[2]}.{time.localtime()[1]}-{time.localtime()[3]}.{time.localtime()[4]}-'
...
model_partial_ft = CatsModel(num_classes=NUM_CLASSES,learning_rate= 1e-5*5)
