...
filename = f'CATS-F_2A_5_5-{time.localtime()[2]}.{time.localtime()[1]}-{time.localtime()[3]}.{time.localtime()[4]}-'
...
model_partial_ft = MODEL(num_classes=NUM_CLASSES,learning_rate= 1e-5*5)
