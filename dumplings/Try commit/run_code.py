...
class DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str = None):
        ...
        self.train_dataset =  dataset_train3
...
filename = f'VGG16-R2+F_NA-{time.localtime()[2]}.{time.localtime()[1]}-{time.localtime()[3]}.{time.localtime()[4]}-'
...
trainer_partial_ft = pl.Trainer(
    ...
    logger=[MLFlowLogger(experiment_name="Dumplings", tracking_uri="file:./mlruns")],
